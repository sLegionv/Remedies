...
class PdTextDataset(Dataset):
    def __init__(self, tokenizer: PreTrainedTokenizer, args, data: pd.Series, block_size=512):

        self.examples = tokenizer.batch_encode_plus(data, add_special_tokens=True, max_length=block_size)["input_ids"]
...
def load_and_cache_examples(args, tokenizer, evaluate=False):
    ...
    return PdTextDataset(tokenizer, args, data=file, block_size=args.block_size)
